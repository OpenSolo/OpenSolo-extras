...
// Checkin $Date: January 4, 2011   10:10:43 $
//###########################################################################
//
...
#if (G71PL != 0)
interrupt void DINTCH1_ISR(void)     // DMA CH1
{
	// Set interrupt priority:
...
#if (G72PL != 0)
interrupt void DINTCH2_ISR(void)     // DMA CH2
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER7.all;
	IER |= M_INT7;
...
#if (G73PL != 0)
interrupt void DINTCH3_ISR(void)     // DMA CH3
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER7.all;
	IER |= M_INT7;
...
#if (G74PL != 0)
interrupt void DINTCH4_ISR(void)     // DMA CH4
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER7.all;
	IER |= M_INT7;
...
#if (G75PL != 0)
interrupt void DINTCH5_ISR(void)     // DMA CH5
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER7.all;
	IER |= M_INT7;
...
#if (G76PL != 0)
interrupt void DINTCH6_ISR(void)     // DMA CH6
{
	// Set interrupt priority:
	volatile Uint16 TempPIEIER = PieCtrlRegs.PIEIER7.all;
	IER |= M_INT7;
