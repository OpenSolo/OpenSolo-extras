...
#elif MAVLINK_C2000
		mav_put_float_c2000(&(msg->payload64[0]), 0, delta_time);
		mav_put_float_c2000(&(msg->payload64[0]), 4, delta_angle_x);
		mav_put_float_c2000(&(msg->payload64[0]), 8, delta_angle_y);
		mav_put_float_c2000(&(msg->payload64[0]), 12, delta_angle_z);
		mav_put_float_c2000(&(msg->payload64[0]), 16, delta_velocity_x);
		mav_put_float_c2000(&(msg->payload64[0]), 20, delta_velocity_y);
		mav_put_float_c2000(&(msg->payload64[0]), 24, delta_velocity_z);
		mav_put_float_c2000(&(msg->payload64[0]), 28, joint_roll);
		mav_put_float_c2000(&(msg->payload64[0]), 32, joint_el);
		mav_put_float_c2000(&(msg->payload64[0]), 36, joint_az);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 40, target_system);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 41, target_component);
