...
#elif MAVLINK_C2000
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 0, yaw_requires_calibration);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 1, pitch_requires_calibration);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 2, roll_requires_calibration);
