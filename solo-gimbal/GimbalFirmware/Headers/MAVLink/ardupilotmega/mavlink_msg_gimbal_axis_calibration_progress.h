...
#elif MAVLINK_C2000
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 0, calibration_axis);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 1, calibration_progress);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 2, calibration_status);
