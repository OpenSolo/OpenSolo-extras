...
#elif MAVLINK_C2000
		mav_put_float_c2000(&(msg->payload64[0]), 0, velocity_variance);
		mav_put_float_c2000(&(msg->payload64[0]), 4, pos_horiz_variance);
		mav_put_float_c2000(&(msg->payload64[0]), 8, pos_vert_variance);
		mav_put_float_c2000(&(msg->payload64[0]), 12, compass_variance);
		mav_put_float_c2000(&(msg->payload64[0]), 16, terrain_alt_variance);
		mav_put_uint16_t_c2000(&(msg->payload64[0]), 20, flags);
