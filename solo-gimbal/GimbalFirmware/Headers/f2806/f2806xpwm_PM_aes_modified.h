/* ==================================================================================
File name:        f2806xpwm_PM_aes_modified.h
                    
Originator:	 Digital Control Systems Group
			 Texas Instruments
Description: Header file containing data type, object, macro definitions and 
			 initializers. This file is specific to "DRV8312" kit and configures
			 PWM 1,2,3
...
#ifndef __F2806X_PWM_H__
#define __F2806X_PWM_H__
...
// Removed TZ3_OST and mapped to TZ1 as FAULTn not mapped to a TZ3 pin in Davinci MDCB
#define  TZSEL_INIT_STATE  ENABLE_TZ1_OST + ENABLE_TZ2_OST
/*----------------------------------------------------------------------------
...
#define PWM_INIT_MACRO(v)													\
	     /* Setup Sync*/													\
         EPwm1Regs.TBCTL.bit.SYNCOSEL = 1;       /* Master KRK*/			\
...
/* Compute the timer period (Q0) from the period modulation input (Q15)*/					\
	...
	/*	EPwm1Regs.CMPB = MPeriod/2;*/	/* Sets ADC sample point */									\
	/*	EPwm2Regs.CMPB = MPeriod/2;	*/															\
/*	EPwm3Regs.CMPB = MPeriod/2;		*/														\
																							\
