...
#elif MAVLINK_C2000
		mav_put_float_c2000(&(msg->payload64[0]), 0, fitness);
		mav_put_float_c2000(&(msg->payload64[0]), 4, ofs_x);
		mav_put_float_c2000(&(msg->payload64[0]), 8, ofs_y);
		mav_put_float_c2000(&(msg->payload64[0]), 12, ofs_z);
		mav_put_float_c2000(&(msg->payload64[0]), 16, diag_x);
		mav_put_float_c2000(&(msg->payload64[0]), 20, diag_y);
		mav_put_float_c2000(&(msg->payload64[0]), 24, diag_z);
		mav_put_float_c2000(&(msg->payload64[0]), 28, offdiag_x);
		mav_put_float_c2000(&(msg->payload64[0]), 32, offdiag_y);
		mav_put_float_c2000(&(msg->payload64[0]), 36, offdiag_z);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 40, compass_id);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 41, cal_mask);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 42, cal_status);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 43, autosaved);
