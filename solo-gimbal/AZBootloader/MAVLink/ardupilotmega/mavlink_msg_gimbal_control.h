...
#elif MAVLINK_C2000
		mav_put_float_c2000(&(msg->payload64[0]), 0, demanded_rate_x);
		mav_put_float_c2000(&(msg->payload64[0]), 4, demanded_rate_y);
		mav_put_float_c2000(&(msg->payload64[0]), 8, demanded_rate_z);
