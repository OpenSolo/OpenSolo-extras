						       ...
						       uint8_t target_system, uint8_t target_component, uint8_t instance, uint8_t pattern, uint8_t custom_len, const uint8_t *custom_bytes)
{
	...
	_mav_put_uint8_t_array(buf, 5, custom_bytes, 24);
		...
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 2, instance);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 3, pattern);
		mav_put_uint8_t_c2000(&(msg->payload64[0]), 4, custom_len);
	
		mav_put_uint8_t_array_c2000(&(msg->payload64[0]), custom_bytes, 5, 24);
...
#else
	return mav_get_uint8_t_array_c2000(&(msg->payload64[0]), custom_bytes, 24,  5);
#endif
}
